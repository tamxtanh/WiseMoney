...
import SuggestionContent from "../../components/tab-custom/SuggestionContent";
import TimeRangePopup from "../../components/modal-popUp/TimeRangePopup";
    ...
    () =>
      rangeOption === "custom" ? (
        <View style={{ backgroundColor: "white", flex: 1 }}>
          ...
          <SuggestionContent content={nestedTabs.content} />
        </View>
      ) : (
        <CustomTabBar
          widthOfPerTab={
