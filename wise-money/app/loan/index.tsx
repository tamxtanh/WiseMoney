        ...
        <View style={styles.container}>
          ...
          <View style={styles.component}>
            ...
            <Text style={styles.description}>
              Choose the method to calculate loan payments
            </Text>
            <View style={styles.inputContainer}>
              <View style={styles.radioContainer}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setCalculationMethod("Even Principal Payments")
                  }
                >
                  <Text
                    style={
                      calculationMethod === "Even Principal Payments"
                ...
                <TouchableOpacity
                  style={styles.radioOption}
                  onPress={() => setCalculationMethod("Even Total Payments")}
                >
                  <Text
                    style={
                      calculationMethod === "Even Total Payments"
                        ? styles.selectedRadio
                        : styles.radio
                    }
                  >
          ...
          <View style={styles.summary}>
            <Text style={styles.summaryText}>
              <Text style={styles.summaryTitle}>Loan Amount: </Text>
              {summary.totalLoanAmount} VND
            </Text>
            <Text style={styles.summaryText}>
              <Text style={styles.summaryTitle}>Total Loan Interest: </Text>
              {summary.totalLoanInterest} VND
            </Text>
          </View>
