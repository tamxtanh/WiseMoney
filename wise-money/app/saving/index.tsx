...
const Savings = () => {
  ...
  const handleCalculate = () => {
    ...
    if (!initialBalance || !interest) {
      Alert.alert(
        "Error",
        "Initial Principal and Compound Interest Rate are required."
      );
      return;
    }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.summary}>
            <Text style={styles.summaryText}>
              <Text style={styles.summaryTitle}>Final Balance: </Text>
              {summary.finalBalance} VND
            </Text>
            <Text style={styles.summaryText}>
              <Text style={styles.summaryTitle}>Total Principal: </Text>
              {summary.totalPrincipal} VND
            </Text>
            <Text style={styles.summaryText}>
              <Text style={styles.summaryTitle}>Total Interest: </Text>
              {summary.totalInterest} VND
            </Text>
            <Text style={styles.summaryText}>
            ...
            <Text style={styles.summaryText}>
              <Text style={styles.summaryTitle}>Net Interest: </Text>
              {summary.netInterest} VND
            </Text>
          </View>
